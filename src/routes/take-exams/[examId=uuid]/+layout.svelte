<script lang="ts">
	...
	import { House, RefreshCcw } from '@lucide/svelte';
...
<svelte:boundary>
		...
		<div class="flex h-full w-full items-center items-start justify-center">
			<Alert.Root class="w-fit">
				...
				<Alert.Description class="flex flex-col items-center justify-start gap-2">
					...
					<div class="w-full">
						<Button onclick={reset} variant="outline" size="sm"><RefreshCcw /> Coba Lagi</Button>
	...
	{/snippet}
	{#snippet pending()}
		<div class="absolute inset-0 flex items-center justify-center overflow-hidden bg-background">
				...
				<div class="animate-fade-in-up mb-12">
					<div class="relative">
						<div class="relative mx-auto mb-6 h-24 w-24">
							<div class="gradient-primary animate-pulse-glow absolute inset-0 rounded-2xl"></div>
							<div
